...
import Icon from '../../images/indust.svg';
...
function DashboardCard02() {
  ...
  .then(function(snapshot) {
    ...
    snapshot.child("Tema/Industria/DataNota").forEach((snap) => {
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-4 bg-white shadow-lg rounded-sm border border-gray-200">
      <div className="px-5 pt-5">
        <header className="flex justify-between items-start mb-2">
          ...
          {/* Menu button */}
          <div className="text-sm font-semibold text-white px-1.5 rounded-full pull-right" ref={chartValue}>{compResult}</div>
        </header>


        <div className="flex justify-between items-start mb-2">
        <div className="text-3xl font-bold text-gray-800 mr-2">Indústria 4.0</div>
